...
import org.bian.dto.CRCustodyArrangementRetrieveOutputModelCustodyArrangementInstanceAnalysis;
import org.bian.dto.CRCustodyArrangementRetrieveOutputModelCustodyArrangementInstanceReportRecord;

import javax.validation.Valid;
  
/**
 * CRCustodyArrangementRetrieveOutputModel
 */
public class CRCustodyArrangementRetrieveOutputModel   {
  ...
  private String custodyArrangementRetrieveActionTaskReference = null;

  private Object custodyArrangementRetrieveActionTaskRecord = null;

  private String custodyArrangementRetrieveActionResponse = null;

  private CRCustodyArrangementRetrieveOutputModelCustodyArrangementInstanceReportRecord custodyArrangementInstanceReportRecord = null;

  private CRCustodyArrangementRetrieveOutputModelCustodyArrangementInstanceAnalysis custodyArrangementInstanceAnalysis = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Custody Arrangement instance retrieve service call 
   * @return custodyArrangementRetrieveActionTaskReference
  **/

  public String getCustodyArrangementRetrieveActionTaskReference() {
    return custodyArrangementRetrieveActionTaskReference;
  }

  public void setCustodyArrangementRetrieveActionTaskReference(String custodyArrangementRetrieveActionTaskReference) {
    this.custodyArrangementRetrieveActionTaskReference = custodyArrangementRetrieveActionTaskReference;
  }
  ...
  **/
   ...
   * @return custodyArrangementRetrieveActionResponse
  **/

  public String getCustodyArrangementRetrieveActionResponse() {
    return custodyArrangementRetrieveActionResponse;
  }

  public void setCustodyArrangementRetrieveActionResponse(String custodyArrangementRetrieveActionResponse) {
    this.custodyArrangementRetrieveActionResponse = custodyArrangementRetrieveActionResponse;
  }
  ...
  **/
  ...
  public CRCustodyArrangementRetrieveOutputModelCustodyArrangementInstanceReportRecord getCustodyArrangementInstanceReportRecord() {
    return custodyArrangementInstanceReportRecord;
  }

  public void setCustodyArrangementInstanceReportRecord(CRCustodyArrangementRetrieveOutputModelCustodyArrangementInstanceReportRecord custodyArrangementInstanceReportRecord) {
  ...
  **/
  ...
  public CRCustodyArrangementRetrieveOutputModelCustodyArrangementInstanceAnalysis getCustodyArrangementInstanceAnalysis() {
    return custodyArrangementInstanceAnalysis;
  }

  public void setCustodyArrangementInstanceAnalysis(CRCustodyArrangementRetrieveOutputModelCustodyArrangementInstanceAnalysis custodyArrangementInstanceAnalysis) {
