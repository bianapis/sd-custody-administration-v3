...
/**
 * BQSettlementInitiateOutputModel
 */
public class BQSettlementInitiateOutputModel   {
  private String settlementInstanceReference = null;

  private String settlementInitiateActionReference = null;

  private Object settlementInitiateActionRecord = null;

  private String settlementInstanceStatus = null;
  ...
  **/
   ...
   * @return settlementInitiateActionReference
  **/

  public String getSettlementInitiateActionReference() {
    return settlementInitiateActionReference;
  }

  public void setSettlementInitiateActionReference(String settlementInitiateActionReference) {
    this.settlementInitiateActionReference = settlementInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Settlement instance (e.g. initialised, pending, active) 
   * @return settlementInstanceStatus
  **/

  public String getSettlementInstanceStatus() {
    return settlementInstanceStatus;
  }

  public void setSettlementInstanceStatus(String settlementInstanceStatus) {
    this.settlementInstanceStatus = settlementInstanceStatus;
  }
