...
/**
 * BQSecuritiesReportingRequestOutputModel
 */
public class BQSecuritiesReportingRequestOutputModel   {
  ...
  private String securitiesReportingRequestActionTaskReference = null;

  private Object securitiesReportingRequestActionTaskRecord = null;

  private String securitiesReportingRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Securities Reporting instance request service call 
   * @return securitiesReportingRequestActionTaskReference
  **/

  public String getSecuritiesReportingRequestActionTaskReference() {
    return securitiesReportingRequestActionTaskReference;
  }

  public void setSecuritiesReportingRequestActionTaskReference(String securitiesReportingRequestActionTaskReference) {
    this.securitiesReportingRequestActionTaskReference = securitiesReportingRequestActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The request service call consolidated processing record 
   * @return securitiesReportingRequestActionTaskRecord
  **/

  public Object getSecuritiesReportingRequestActionTaskRecord() {
    return securitiesReportingRequestActionTaskRecord;
  }

  public void setSecuritiesReportingRequestActionTaskRecord(Object securitiesReportingRequestActionTaskRecord) {
    this.securitiesReportingRequestActionTaskRecord = securitiesReportingRequestActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Securities Reporting service request record 
   * @return securitiesReportingRequestRecordReference
  **/

  public String getSecuritiesReportingRequestRecordReference() {
    return securitiesReportingRequestRecordReference;
  }

  public void setSecuritiesReportingRequestRecordReference(String securitiesReportingRequestRecordReference) {
    this.securitiesReportingRequestRecordReference = securitiesReportingRequestRecordReference;
  }
